...
window.localization = window.localization || {},
    function(n) {
        localization.translate = {
            ...
            init: function() {
                i18n.__('app-name').then((trans)=> $(document).find("title").text(trans));
